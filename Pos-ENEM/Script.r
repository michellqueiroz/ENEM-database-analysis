...
enem2012 <- transform(enem2012, IN_STATUS_REDACAO = as.numeric(IN_STATUS_REDACAO), TP_SEXO = as.numeric(TP_SEXO), ST_CONCLUSAO = as.numeric(ST_CONCLUSAO),
...
#nem2012$IDADE <- (enem2012$IDADE-min(enem2012$IDADE))/(max(enem2012$IDADE)-min(enem2012$IDADE))
